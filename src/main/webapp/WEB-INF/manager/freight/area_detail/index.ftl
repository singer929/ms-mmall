	...
	<@ms.panel>
		...
		<@ms.contentBody width="85%" style="overflow-y: hidden;">
			<@ms.contentPanel  style="margin:0;padding:0;overflow-y: hidden;">
	           	<iframe src="${managerPath}/freight/areaDetail/list.do?faId=189" style="width:100%;maring:0;padding:0;border:none;height:100%;background-repeat: no-repeat;  background-position: center;" id="listFrame" target="listFrame" ></iframe>
			</@ms.contentPanel>
		</@ms.contentBody>
	</@ms.panel>
</@ms.html5>
